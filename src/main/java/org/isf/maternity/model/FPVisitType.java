...
public enum FPVisitType {
    ...
    EMERGENCY("angal.maternity.fpvisittype.emergency"),
    SIDE_EFFECT("angal.maternity.fpvisittype.sideeffect"),
    DISCONTINUATION("angal.maternity.fpvisittype.discontinuation");

    private final String key;

    FPVisitType(String key) {
        this.key = key;
    }
