...
public class FamilyPlanningVisit extends Auditable<String> {
    ...
    @Column(name = "FPV_VISIT_TYPE")
    private FPVisitType visitType;

    @Nullable
    @Column(name = "FPV_COMPLAINTS", columnDefinition = "LONGTEXT")
    ...
    public FamilyPlanningVisit(FamilyPlanning familyPlanning, LocalDateTime visitDate, FPVisitType visitType) {
    ...
    public FPVisitType getVisitType() {
        return visitType;
    }

    public void setVisitType(FPVisitType visitType) {
        this.visitType = visitType;
    }
    ...
    public void setComplaints(@Nullable String complaints) {
