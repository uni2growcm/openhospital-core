...
public class FamilyPlanningMethodHistoryIoOperation {

    private final FamilyPlanningMethodHistoryIoOperationRepository repository;

    public FamilyPlanningMethodHistoryIoOperation(FamilyPlanningMethodHistoryIoOperationRepository repository) {
    ...
    public List<FamilyPlanningMethodHistory> getMethodHistoryByFamilyPlanning(Integer familyPlanningId) throws OHServiceException {
        return repository.findByFamilyPlanningIdOrderByStartDateAsc(familyPlanningId);
    }
}
