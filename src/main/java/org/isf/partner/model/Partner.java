...
public class Partner extends Auditable<String> {
	...
	public Partner(String name, PartnerType type, String contactPerson,
	...
	public Partner(Integer code, String name, PartnerType type, String contactPerson,
			String phone, String email, String address, String notes) {
		this.code = code;
		this.name = name;
		this.type = type;
