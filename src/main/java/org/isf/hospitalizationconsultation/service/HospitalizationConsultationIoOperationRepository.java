...
public interface HospitalizationConsultationIoOperationRepository extends JpaRepository<HospitalizationConsultation, Integer> {

	List<HospitalizationConsultation> findByEncounter(Encounter encounter);
