...
public final class GeneralData extends ConfigurationProperties {
	...
	public static boolean ENABLEBILLITEMGROUP;
	...
	public static boolean MALNUTRITIONMODULEENABLED;
	public static boolean HIVMODULEENABLED;
	public static boolean FAMILYPLANNINGMODULEENABLED;
	public static boolean HOMEVISITMODULEENABLED;
	...
	private static final boolean DEFAULT_ENABLEBILLITEMGROUP  = false;
	...
	private static final boolean DEFAULT_MALNUTRITIONMODULEENABLED = true;
	...
	private GeneralData(String fileProperties) {
		...
		ENABLEBILLITEMGROUP = myGetProperty("ENABLEBILLITEMGROUP", DEFAULT_ENABLEBILLITEMGROUP);
		...
		MALNUTRITIONMODULEENABLED = myGetProperty("MALNUTRITIONMODULEENABLED", DEFAULT_MALNUTRITIONMODULEENABLED);
		HIV_INFANT_MAX_AGE_MONTHS = myGetProperty("HIV_INFANT_MAX_AGE_MONTHS", DEFAULT_HIV_INFANT_MAX_AGE_MONTHS);
		HIVMODULEENABLED = myGetProperty("HIVMODULEENABLED", DEFAULT_HIVMODULEENABLED);
		FAMILYPLANNINGMODULEENABLED = myGetProperty("FAMILYPLANNINGMODULEENABLED", DEFAULT_FAMILYPLANNINGMODULEENABLED);
		HOMEVISITMODULEENABLED = myGetProperty("HOMEVISITMODULEENABLED", DEFAULT_HOMEVISITMODULEENABLED);
