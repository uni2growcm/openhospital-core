...
import org.isf.orthanc.client.FeignClientFactory;
...
public class OrthancAPIClientService {
	...
	public OrthancAPIClientService(FeignClientFactory feignClientFactory) {
	 ...
	 * @throws OHServiceException see when {@link FeignClientFactory#createClient()} throws this exception
	 */
