...
@Component
public class PriceOtherReductionManager {
	private final PriceOtherReductionIoOperation priceOtherReductionIoOperation;

	PriceOtherReductionManager(PriceOtherReductionIoOperation priceOtherReductionIoOperation) {
		this.priceOtherReductionIoOperation = priceOtherReductionIoOperation;
	}
	...
	public PriceOtherReduction save(PriceOtherReduction priceOtherReduction) throws OHServiceException {
		return priceOtherReductionIoOperation.save(priceOtherReduction);
	}
	 ...
	 */
	public List<PriceOtherReduction> getByReductionPlanId(int reductionPlanId) throws OHServiceException {
		return priceOtherReductionIoOperation.getByReductionPlanId(reductionPlanId);
	}
	 ...
	 */
	public void delete(PriceOtherReduction priceOtherReduction) throws OHServiceException {
		priceOtherReductionIoOperation.delete(priceOtherReduction);
	}
}
