...
public class ReductionPlanIoOperations {
	...
	private final OperationReductionIoOperationRepository operationReductionRepository;
	private final PriceOtherReductionIoOperationRepository priceOtherReductionRepository;

	public ReductionPlanIoOperations(
		ReductionPlanIoOperationRepository reductionPlanIoOperationRepository,
		ExamReductionIoOperationRepository examReductionIoOperationsRepository,
	 ...
	 */
	private <T> List<OHExceptionMessage> validateRates(Collection<T> reductions, Function<T, BigDecimal> rateExtractor, String errorMsg) {
