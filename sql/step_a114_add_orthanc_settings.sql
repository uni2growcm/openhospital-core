...
(NULL, 'ORTHANCBASEURL', 'text', NULL, '', '', 'Base URL of the ORTHANC server', 'admin', NULL, NOW(), NULL, 1, 1, 'application'),
...
(NULL, 'ORTHANCEXPLORERURL', 'text', NULL, '', '', 'Full URL of the ORTHANC explorer', 'admin', NULL, NOW(), NULL, 1, 1, 'application');