...
source u2g_update/step_04_add_column_bll_guarantor_to_table_oh_bills.sql;
source u2g_update/step_05_create_table_for_reductionplan.sql;
source u2g_update/step_06_add_reduction_plan_in_table_patient.sql;
source u2g_update/step_07_add_bodycompartment_table.sql;
source u2g_update/step_8_reorganize_mortuary_menu.sql;
source u2g_update/step_9_add_deathreanson_on_mortuary_menu.sql;
source u2g_update/step_10_add_foreign_key_on_death_table.sql;
source u2g_update/step_11_add_column_bll_ward_to_table_oh_bills.sql;
source u2g_update/step_12_add_pregnancycare_menuitem_and_privilege_for_groupmenu.sql;
...
source step_a121_create_table_typologies.sql;
source step_a122_maternity_pregnancy.sql;
source step_a123_maternity_pregnancy_visit.sql;
