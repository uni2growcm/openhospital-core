...
INSERT INTO `oh_orthanc_user`(`ORC_ID`, `ORC_USER_NAME`, `ORC_US_ID_A`, `ORC_PASSWORD`, `ORC_CREATED_BY`, `ORC_CREATED_DATE`, `ORC_LAST_MODIFIED_BY`, `ORC_LAST_MODIFIED_DATE`, `ORC_ACTIVE`) VALUES (1,'u2g','admin','u2g123',NULL,NULL,NULL,NULL,1);
